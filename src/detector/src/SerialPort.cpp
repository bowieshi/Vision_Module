...
#ifdef _WIN32
bool SerialPort::m_Open(const char* portname,
    int baudrate,
    char parity,
    char databit,
    char stopbit,
...
bool SerialPort::OpenPort(const std::string& portname, int baudrate, char parity, char databit, char stopbit, char synchronizeflag)
{
